...
class ReportGenerator:
    ...
    def _save_csv_files(self, tx_df, user_df):
        tx_df.to_csv("D:\\ITI\\9 Months Training AI\\python\\Final Project\\Output\\flagged_transactions_report.csv", index=False)
        user_df.to_csv("D:\\ITI\\9 Months Training AI\\python\\Final Project\\Output\\flagged_users_report.csv", index=False)
    ...
    def _generate_fancy_txt(self, tx_df, user_df):
        ...
        with open("D:\\ITI\\9 Months Training AI\\python\\Final Project\\Output\\executive_summary.txt", "w", encoding="utf-8") as f:
            f.write("💎" + "—" * 50 + "💎\n")
    ...
    def display_summary(self):
        with open("D:\\ITI\\9 Months Training AI\\python\\Final Project\\Output\\executive_summary.txt", "r", encoding="utf-8") as f:
            summary = f.read()
            print(summary)